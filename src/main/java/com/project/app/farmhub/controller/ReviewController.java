...
public class ReviewController {
	...
	public ResponseEntity<WebResponse<String>> add(@Valid @RequestBody CreateReviewRequest request) {
	...
	public ResponseEntity<WebResponse<String>> edit(@Valid @RequestBody UpdateReviewRequest request) {
